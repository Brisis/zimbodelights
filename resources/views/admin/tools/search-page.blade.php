...
<head>
    ...
    <title> Search Page - ZimboDelights | E-Commerce HTML Admin Dashboard Template </title>
...
<div class="layout-wrapper">
    ...
    <!-- ./ Logo -->
    <div class="page-title">Search Page</div>
        ...
        <div class="tab-pane fade" id="photos" role="tabpanel">
            <div class="row g-4">
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                    <a href="assets/images/portfolio-one.jpg"
                       class="image-popup-gallery-item">
                        <img class="img-fluid rounded"
                             src="assets/images/portfolio-one.jpg"
                             alt="image">
                    </a>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                    <a href="assets/images/portfolio-two.jpg"
                       class="image-popup-gallery-item">
                        <img class="img-fluid rounded"
                             src="assets/images/portfolio-two.jpg"
                             alt="image">
                    </a>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                    <a href="assets/images/portfolio-three.jpg"
                       class="image-popup-gallery-item">
                        <img class="img-fluid rounded"
                             src="assets/images/portfolio-three.jpg"
                             alt="image">
                    </a>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                    <a href="assets/images/portfolio-four.jpg"
                       class="image-popup-gallery-item">
                        <img class="img-fluid rounded"
                             src="assets/images/portfolio-four.jpg"
                             alt="image">
                    </a>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                    <a href="assets/images/portfolio-five.jpg"
                       class="image-popup-gallery-item">
                        <img class="img-fluid rounded"
                             src="assets/images/portfolio-five.jpg"
                             alt="image">
                    </a>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                    <a href="assets/images/portfolio-six.jpg"
                       class="image-popup-gallery-item">
                        <img class="img-fluid rounded"
                             src="assets/images/portfolio-six.jpg"
                             alt="image">
                    </a>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
...
<script src="libs/bundle.js"></script>
    ...
    <script src="dist/js/examples/lightbox.js"></script>
