...
<head>
    ...
    <title> Access Denied - ZimboDelights | E-Commerce HTML Admin Dashboard Template </title>
        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>
                        <a  class="active"
                            href="./access-denied.html">Access Denied</a>
                    </li>
                    <li>
...
<div class="layout-wrapper">
    ...
    <div class="row mb-5">
        <div class="col-md-3 m-auto">
            <figure>
                <img class="w-100" src="assets/svg/access-denied.svg" alt="image">
            </figure>
        </div>
    </div>
