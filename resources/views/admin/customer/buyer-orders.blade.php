...
<head>
    ...
    <title> My Orders - ZimboDelights | E-Commerce HTML Admin Dashboard Template </title>
        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>
                        <a  class="active"
                            href="./buyer-orders.html">Orders</a>
                    </li>
                    <li>
                ...
                <div class="table-responsive">
                    <table class="table table-custom mb-0">
                        ...
                        <tr>
                            <td>
                                <a href="#">
                                    <img src="assets/images/products/2.jpg" class="rounded"
                                         width="40" alt="...">
                                </a>
                            </td>
                            <td>Shoe</td>
            ...
            <div class="card">
                <div class="card-body">
                    <ul class="nav nav-pills flex-column gap-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link  active " href="./buyer-orders.html">My Orders</a>
                        </li>
                        <li class="nav-item">
