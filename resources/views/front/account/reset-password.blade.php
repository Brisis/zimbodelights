    ...
    <section class="form-section px-15 top-space section-b-space">
        ...
        <form>
            <div class="form-floating mb-4">
                <input type="password" class="form-control" id="one" placeholder="Current Password">
                <label for="one">Current Password *</label>
            </div>
            <div class="form-floating mb-4">
                <input type="password" class="form-control" id="two" placeholder="New Password">
                <label for="two">New Password *</label>
            </div>
            <div class="form-floating mb-4">
                <input type="password" class="form-control" id="three" placeholder="Confirm Password">
                <label for="three">Confirm Password *</label>
            </div>
            <a href="#" class="btn btn-solid w-100">RESET PASSWORD</a>
        </form>
