...
<body>
    ...
    <section class="top-space lg-space px-15 pt-0">
        <div class="row g-3">
            <div class="col-12"><a class="btn btn-outline w-100" data-bs-toggle="modal" data-bs-target="#filterModal"
                    href="javascript:void(0)">Filter Selection</a></div>
            <div class="col-12"><a class="btn btn-outline w-100" data-bs-toggle="offcanvas" data-bs-target="#selectQty"
                    href="javascript:void(0)">Select Quantity</a></div>
            <div class="col-12"><a class="btn btn-outline w-100" data-bs-toggle="offcanvas" data-bs-target="#selectSize"
                    href="javascript:void(0)">Select Size</a></div>
            <div class="col-12"><a class="btn btn-outline w-100" data-bs-toggle="offcanvas" data-bs-target="#removecart"
                    href="javascript:void(0)">Remove Cart</a></div>
        </div>
    </section>
    <!-- modal section end -->
