...
<body>
    ...
    <section class="overflow-hidden">
        <div class="onboarding-slider theme-dots">
            <div>
                <img src="assets/images/onboarding/1.png" class="img-fluid" alt="">
                <div class="boarding-content mt-4">
                    <h2>Welcome to Biggest Online Store</h2>
                    <p>Latest trends in clothing for women, men & kids at ZimboDelights. Find new arrivals​, fashion
                        catalogs, collections & lookbooks every week.</p>
                </div>
            </div>
            <div>
                <img src="assets/images/onboarding/2.png" class="img-fluid" alt="">
                <div class="boarding-content mt-4">
            ...
            <div>
                <img src="assets/images/onboarding/3.png" class="img-fluid" alt="">
                <div class="boarding-content mt-4">
    ...
    <section class="section-b-space pt-3 px-15">
        <a href="index.html" class="btn btn-solid w-100">Start Shopping</a>
        <div class="bottom-detail text-center mt-3">
            <h4 class="content-color">Have an account? <a class="title-color text-decoration-underline"
